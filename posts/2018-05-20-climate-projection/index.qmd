...
description: "Combining dose-response functions with climate projections to estimate future impacts"
...
pacman::p_load(data.table, tidyverse, splines, survey, lfe, scales)
```
