...
description: "Strategies for research productivity including work scheduling, Pomodoro technique, and organizing academic work with markdown and Dropbox."
...
::: {.callout-warning}
December 2022: I've left this post up for posterity, but I habitually reinvent my work process every six months or so, so at this point these notes are well out of date. My philosophy around "productivity" continues to evolve, as does the set of tools I use. 
:::
