...
description: "Using Python's rasterstats package to compute faster zonal statistics for raster data across polygons, with installation instructions and sample code."
