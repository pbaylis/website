...
description: "Using svycontrast for linear combinations of regression coefficients"
...
::: {.callout-note}
I still use a version of this occasionally, but the various marginal effects package -- specifically `marginaleffects` seem to replicate most of the functionality I need these days.
:::
