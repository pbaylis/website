...
__Update (April 2018): This post deprecated, as these days I estimate spatial econometric models using clustered standard errors and in R. There are Conley implementations in R, but so far as I can tell the technique has become less popular over time and all of those that I know of suffer from performance issues.__
