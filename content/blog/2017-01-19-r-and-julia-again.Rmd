...
__Update (April 2018): Julia has changed quite a bit since I originally wrote this. `FixedEffectsModels.jl` still exists, but I still frequently run into strange errors when estimating. As of now, I still resort to sampling and running large regressions in `lfe::felm` in `R`__.
