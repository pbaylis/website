...
The first sets a track pattern. The second line creates a gitattributes file that also stores the tracked patterns. I'm not certain why git doesn't take care of this itself, though.
