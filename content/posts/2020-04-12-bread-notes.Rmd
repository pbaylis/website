...
2. **Mix your ingredients** (except 25g of water and the salt). Wait 30 minutes. Mix in the 25g of water and salt. 

3. **Fold / Bulk Fermentation**. For the next 4 hours, you'll "turn" the dough every 30 minutes. To turn the dough, reach underneath, pull it up (stretching it out), and rotate it (example video [here](https://www.youtube.com/watch?v=3_5x70h14VQ&t=77)) Do this a few times. While you're doing this, the dough will also be expanding (this is the bulk fermentation). 

4. **Shaping**. After the bulk fermentation is the complete, you'll shape the dough. This means you'll form it into a ball shape and pull it across your tabletop to create tension in the dough (example video [here](http://www.TODO.com)). Wait 30 minutes, and do it again.
