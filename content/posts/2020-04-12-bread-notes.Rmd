...
And now for something completely different... sourdough! I first began baking as an escape from grad school ennui. Since then, and especially in last couple months, it's been fun to share a few of the tips and tricks I've picked up along the way with friends who are just getting into baking. The notes that follow document some of what I've learned. Of course, they're a work in progress and I'm learning more every time I bake. But maybe you'll find them useful. I've split this post up into two major sections: the first section, "**Forget the details, I just want to make bread!**", walks you through the steps of making sourdough as quickly as possible. The second section, "**Gimme allll the details**", does just that.

If you find these notes useful, [send me a picture](https://twitter.com/pbaylis) of your bread! I'd love to see it. 

# Forget the details, I just want to make bread!

1. **Get some starter and the rest of the ingredients**. The easy way to get starter is to borrow from someone who already has a healthy one. The less easy (but not that difficult) way is to make your own. See the "starting a starter" subsection below.

These are the ingredients you'll need (makes one loaf of bread):
...
2. **Mix your ingredients** (except 25g of water and the salt) until fully combined in a large bowl that you can cover with saran wrap or a lid. Cover it and wait 30 minutes. Mix in the 25g of water and salt. 

3. **Fold / Bulk Fermentation**. For the next 4 hours, you'll "turn" the dough every 30 minutes. To turn the dough, reach underneath, pull it up (stretching it out), fold it over itself, and rotate it (example video [here](https://www.youtube.com/watch?v=3_5x70h14VQ&t=77)) Do this a few times (covering the dough in between). Note that during this process, the dough will become smoother and begin to expand, which is why this step is also called the bulk fermentation. 
...
- [Nice walkthrough of one baker's process](https://www.youtube.com/watch?v=BJEHsvW2J6M)
