...
1. **Get some starter and the rest of the ingredients**. The easy way to get sourdough starter is to borrow from someone who already has a healthy one. The less easy (but not that difficult) way is to make your own. See the "starting a starter" in the detail section if you want to try. 
