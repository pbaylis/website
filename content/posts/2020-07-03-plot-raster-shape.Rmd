...
I'm often overlaying rasters with shapefiles in order to get, for example, the average weather for Indonesia. I've foudnn that it's immensely important that I __map my data__ when I'm doing this sort of thing, to make sure that I'm not making any boneheaded mistakes (e.g., using the wrong projection). Here's an example of a map like that, where the color of the cells indicates whether or not we have data there, plus the code I used to create it.
