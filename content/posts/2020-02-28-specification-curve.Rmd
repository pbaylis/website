...
I wanted to roll my own, though. Since my code is fairly simple (less than 60 lines include comments and generous spacing) and uses the [`tidyverse`](https://www.tidyverse.org/), it may be helpful to other people too. First, here's the output.

![](/static/img/specification-curve.png)
