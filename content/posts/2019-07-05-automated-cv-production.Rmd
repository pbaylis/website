---
layout: post
title: "Automated reference and abstract creation - a work in p"
date: 2019-07-05
output:
...
The current version of how I do this can be found in this GitHub [repo](https://github.com/pbaylis/baylis-CV). In short, it uses a makefile and multiple runs of `pandoc` (with custom templates) to create both my [CV](/pdf/Baylis_CV) (a PDF) and my [research](/research) page.
