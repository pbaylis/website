...
Another puzzle I haven't figured out. If I estimate a model with fixed effects that take out the level of, say, region, can I still compare response functions for different regions? I mean... all \\( \beta_1 \\) introduces is a mean shift.
