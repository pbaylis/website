...
There's a bit more beneath the hood of this code. You'll want to refer to the code of [`reg_felm`](https://github.com/pbaylis/baylisR/blob/master/R/reg_felm.R) to see how to call it.
